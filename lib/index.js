(function (global, factory) {
  ...
  (global = global || self, global.IndexList = factory(global.React, global.PropTypes, global.BScroll));
}(this, function (React, PropTypes, BScroll) { 'use strict';
  ...
  function (_PureComponent) {
    ...
    createClass(IndexList, [{
      ...
      value: function render() {
        ...
        return React__default.createElement(Scroll, {
          ...
          return React__default.createElement("li", {
            ...
            }, renderItem ? renderItem(item) : React__default.createElement("span", {
              className: "name"
            }, item.name));
          })));
