(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('better-scroll')) :
  typeof define === 'function' && define.amd ? define(['react', 'better-scroll'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.IndexList = factory(global.React, global.BScroll));
}(this, (function (React, BScroll) { 'use strict';
  ...
  var Scroll = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
    ...
    var _initScroll = function _initScroll() {
      ...
      scrollRef.current = new BScroll__default['default'](wrapperRef.current, {
        probeType: probeType,
        click: click
      });
  ...
  var IndexList = function IndexList(_ref) {
    ...
    var listViewRef = React.useRef();
    var fixedRef = React.useRef();
    var probeType = 3;
    ...
    return /*#__PURE__*/React__default['default'].createElement(Scroll, {
      ...
      ref: listViewRef
    }, /*#__PURE__*/React__default['default'].createElement("ul", null, data.map(function (group, index) {
      return /*#__PURE__*/React__default['default'].createElement("li", {
      ...
      }, group.title), /*#__PURE__*/React__default['default'].createElement("ul", null, group.items.map(function (item, key) {
        return /*#__PURE__*/React__default['default'].createElement("li", {
        ...
        }, renderItem ? renderItem(item) : /*#__PURE__*/React__default['default'].createElement("span", {
          className: "name"
        }, item.name));
      })));
    ...
    }, /*#__PURE__*/React__default['default'].createElement("ul", null, shortcutList.map(function (item, index) {
      ...
      ref: fixedRef
    }, fixedTitle ? /*#__PURE__*/React__default['default'].createElement("div", {
